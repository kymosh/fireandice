packages <- c('tidymodels', 'dplyr', 'tidyr', 'lme4', 'lmtest', 'ranger', 'tictoc', 'mgcv')
...
# ------------------ find best canopy-metrics-only model * this was for creek only * --------------------
# ----- stepwise 1 -----
